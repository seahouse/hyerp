...
namespace App\Http\Controllers\util\taobaosdk\dingtalk;

include_once app_path() . "/Http/Controllers/util/taobaosdk/TopSdk.php";
//var_dump(include_once "../TopSdk.php");
//include "../TopSdk.php";

use App\Http\Controllers\util\taobaosdk\top\ResultSet;
use App\Http\Controllers\util\taobaosdk\top\TopLogger;
//use App\Http\Controllers\util\taobaosdk;
