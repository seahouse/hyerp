...
use App\Models\Basic\Factory_hxold;
...
//                        });
        ...
        if (isset($pppayment))
        {
            ...
            $input['contracting_company'] = "";
            $factory = Factory_hxold::find($input['productioncompany_id']);
            if (isset($factory))
            {
                $company = $factory->company;
                if (isset($company))
                    $input['contracting_company'] = $company->name;
            }
