...
class CreateReimbursementsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reimbursements', function (Blueprint $table) {
            ...
            $table->integer('reimbursementtype_id');        // 报销类别
            ...
            $table->integer('approvaler1_id');              // 审批人1（出纳，初审）
            $table->date('approvaldate1');                  // 审批日期1
            $table->integer('approvaler2_id');              // 审批人2（销售副总，复审）
            $table->date('approvaldate2');                  // 审批日期2
            $table->integer('approvaler3_id');              // 审批人3（总经理，终审）
            $table->date('approvaldate3');                  // 审批日期3
