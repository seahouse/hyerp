...
@can('sales_bonuspayment_create')
    {!! Form::open(array('url' => 'sales/' . $sohead->id . '/bonuspayment/store', 'class' => 'form-horizontal', 'id' => 'formMain', 'files' => true)) !!}
        @include('sales.bonuspayments._form',
        	[
        		'submitButtonText' => '提交', 
        		'supplier_name' => null,
        		'pohead_number' => null,
