<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('fabric_sequence_no', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('material_code', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('fabric_description', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('shrinkage', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('hand_feel', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('for_washing', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('for_crocking', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('yarn_count', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('IO_description', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('positive_percentage_tolerance', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('negative_percentage_tolerance', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('transportation_method_type_code', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('sample_description', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('prodn_description', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('color_sequence', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('color_desc1', null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('color_desc2', null, ['class' => 'form-control']) !!}
    </div>
</div>
