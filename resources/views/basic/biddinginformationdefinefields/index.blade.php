...
@section('main')
    ...
    <div class="panel-heading">
        <a href="{{ url('basic/biddinginformationdefinefields/create') }}" class="btn btn-sm btn-success">新增</a>
...
{{--            {!! Form::select('template_name', $dtlog_templatenames, null, ['class' => 'form-control', 'placeholder' => '--日志模板--']) !!}--}}
    ...
    @if ($biddinginformationdefinefields->count())
    <table class="table table-striped table-hover table-condensed">
        ...
        <tbody>
            @foreach($biddinginformationdefinefields as $biddinginformationdefinefield)
                <tr>
                    <td>
                        {{ $biddinginformationdefinefield->name }}
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="form-inline">
                            <a href="{{ URL::to('/basic/biddinginformationdefinefields/'.$biddinginformationdefinefield->id.'/edit') }}" class="btn btn-success btn-sm pull-left">编辑</a>
                            ...
                            {!! Form::open(array('route' => array('basic.biddinginformationdefinefields.destroy', $biddinginformationdefinefield->id), 'method' => 'delete', 'onsubmit' => 'return confirm("确定删除此记录?");')) !!}
    ...
    {!! $biddinginformationdefinefields->setPath('/basic/biddinginformationdefinefields')->appends($inputs)->links() !!}
