    ...
    @if ($dtlog->template_name == '项目经理施工日志')
        <div class="form-group">
            ...
            <div class='col-xs-8 col-sm-10'>
                {!! Form::text('xmjlsgrz_peoplecount', $dtlog->xmjlsgrz_peoplecount(), ['class' => 'form-control', 'data-toggle' => 'modal', 'data-target' => '#selectProjectModal', 'data-name' => 'project_name', 'data-id' => 'sohead_id', 'placeholder' => '点击选择']) !!}
