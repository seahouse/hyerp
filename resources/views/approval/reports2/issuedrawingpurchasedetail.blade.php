...
<div class="panel-body">
    <div class="pull-right">
        ...
        <div class="row">
            ...
            {!! Form::submit('铆焊统计', ['class' => 'btn btn-default btn-sm', 'id' => 'btnExport5']) !!}
            {!! Form::close() !!}
...
<script type="text/javascript">
    jQuery(document).ready(function(e) {
        ...
        var tableMcitempurchase = $('#tableMcitempurchase').DataTable({
            ...
            "columns": [{
                    "data": "created_date",
                    "name": "mcitempurchases.created_at",
                    "searchable": false
                },
                {
                    "data": "manufacturingcenter",
        ...
        var tablePppayment = $('#tablePppayment').DataTable({
            ...
            "columns": [{
                    "data": "created_date",
                    "name": "pppaymentitems.created_at"
                },
                {
                    "data": "tonnage_paowan",
                    "name": "tonnage_paowan"
                ...
                {
                    "data": "tonnage_rengong",
                    "name": "tonnage_rengong"
                },
                {
                    "data": "tonnage_maohan",
                    "name": "tonnage_maohan"
                ...
                {
                    "data": "tonnage_waixieyouqi",
                    "name": "tonnage_waixieyouqi"
                },
                {
                    "data": "productioncompany",
                    "name": "productioncompany"
