            ...
            <div class="modal-body">
            	<div class="input-group" style="width:100%;">
                    <div class='col-xs-4 col-sm-4' style="padding:5px;">
                        {!! Form::select('type', array('projectsitepurchase' => '工程采购(ERP)', 'importantcorrespondence' => '通用-重要函件通告', 'installationsiteaddition' => 'EPC-安装队现场增补', 'arrivalrequestandplannotice' => '项目现场-到货要求及计划通知'), null, ['class' => 'form-control', 'placeholder' => '--请选择--', 'id' => 'approvaltype']) !!}
                    </div>
