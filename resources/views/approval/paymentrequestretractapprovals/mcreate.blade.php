...
@section('for_paymentrequestretractapprovals_create')
    @include('approval.paymentrequestretractapprovals._form',
    	[
    		'acceptButtonText' => '同意', 
    		'rejectButtonText' => '拒绝', 
    		'date' => date('Y-m-d'),
	...
	<script type="text/javascript">		
		jQuery(document).ready(function(e) {
			...
			$("#btnAccept").bind("click", function() {
				$.ajax({
					type: "POST",
					url: "{{ url('approval/paymentrequestretractapproval/mstore') }}",
