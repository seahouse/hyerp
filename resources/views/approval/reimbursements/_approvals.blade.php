@if (isset($reimbursement))
    ...
    <div class="form-group">
        {!! Form::label('approver', '审批人:', ['class' => 'col-xs-6 col-sm-2 control-label']) !!}
    ...
    <div class="form-group">
        {!! Form::label('status', '审批结果:', ['class' => 'col-xs-6 col-sm-2 control-label']) !!}
        <div class='col-sm-10 col-xs-6'>
    ...
    <div class="form-group">
        {!! Form::label('description', '审批描述:', ['class' => 'col-xs-6 col-sm-2 control-label']) !!}
        <div class='col-sm-10 col-xs-6'>
