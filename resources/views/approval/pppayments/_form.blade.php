...
<div class="form-group">
    ...
    {!! Form::select('productioncompany', array('苏州分公司' => '苏州分公司', '泰州分公司' => '泰州分公司', '胶州分公司' => '胶州分公司', '郎溪分公司' => '郎溪分公司'), null, ['class' => 'form-control', 'placeholder' => '--请选择--', $attr, $attrdisable, 'id' => 'productioncompany']) !!}
    </div>
</div>
